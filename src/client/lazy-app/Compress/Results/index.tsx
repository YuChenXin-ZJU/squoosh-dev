...
export default class Results extends Component<Props, State> {
  ...
  render(
    { source, imageFile, downloadUrl, flipSide, typeLabel, locale }: Props,
    ...
    if (source && imageFile) {
      ...
      ratioPercent = Math.round(diff * 100);
    }
    ...
    return (
      ...
      >
          ...
          <div class={style.bubbleInner}>
            ...
            <div class={style.percentInfo}>
              ...
              <div class={style.percentOutput}>
                ...
                <span class={style.sizeValue}>
                  {isOriginal ? 100 : ratioPercent || 0}
                </span>
        ...
        <a
          ...
          title={t(locale, { zh: '下载', en: 'Download' })}
          onClick={this.onDownload}
        >
          <svg class={style.downloadBlobs} viewBox="0 0 89.6 86.9">
            <title>{t(locale, { zh: '下载', en: 'Download' })}</title>
